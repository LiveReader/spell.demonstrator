...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NotitiaTaxonomy', function() {
      beforeEach(function() {
        instance = new SpellApi.NotitiaTaxonomy();
      });

      it('should create an instance of NotitiaTaxonomy', function() {
        // TODO: update the code to test NotitiaTaxonomy
        expect(instance).to.be.a(SpellApi.NotitiaTaxonomy);
      });
