...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OntologyClass', function() {
      beforeEach(function() {
        instance = new SpellApi.OntologyClass();
      });

      it('should create an instance of OntologyClass', function() {
        // TODO: update the code to test OntologyClass
        expect(instance).to.be.a(SpellApi.OntologyClass);
      });
