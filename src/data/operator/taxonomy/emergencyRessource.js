...
const emergencyRessource = {
	...
	identifier: { label: "Kennung", type: Type.Text, size: 40, value: null, id: "481de74d-a8a9-506d-a80f-17714046813f" },
	...
	time: { label: "Zeit", type: Type.Text, size: 40, value: null, id: "cdb68048-15f6-5f4b-a74a-00cd6d3f79a0" },
	location: location,
};
