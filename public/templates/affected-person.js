affectedPerson.shapeSize = 300;

function affectedPerson(data, initialShape, changes, Template) {
	const {
		Shape,
		SVGShape,
		ShapeStyle,
	...
	Shape.transform(shape, true, data.shape.scale * affectedPerson.shapeSize);
	return shape;
